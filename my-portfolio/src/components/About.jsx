...
const About = () => {
  return (
    ...
    <h1 className='absolute text-grey/40 md:text-[170px] sm:text-[100px] text-[80px] md:tracking-widest font-poppins font-extrabold text-center md:text-left'>About 
    </h1>
    ...
    I’m a Frontend Developer. I have a serious passion for UI effects, animations and creating intuitive, dynamic user experiences.I am  Well-organised, inquisitive, also pay high attention to detail. Fan of Music, outdoor activities. Interested in the entire MERN Stack spectrum and looking foward to working on ambitious projects with positive people. <br/> <br/>
...
<div className='skills md:w-[33.3%] p-10'>
  <h1 className='text-[32px] font-semibold'>Web <br/> Development</h1>
  <p className='font-opensans leading-loose font-bold mt-4'>I create awesome websites and also the fix technical aspects, such as its performance and capacity.</p>
  <img src={code} alt="coding" className='mt-6' />
</div>
<div className=' skills md:w-[33.3%] p-10'>
  <h1 className='text-[32px] font-semibold'>Problem <br/> Solving</h1>
  <p className='font-opensans leading-loose font-bold mt-4'>I find desired solutions to a problem, and applying best practices to achieve the best and befitting result.</p>
  <img src={solve} alt="problem-solving" className='mt-6' />
</div>
<div className='skills md:w-[33.3%] p-10'>
  <h1 className='text-[32px] font-semibold'>Responsive <br/> Design</h1>
  <p className='font-opensans leading-loose font-bold mt-4'>Using the best technologies and frame works to make the best responsive website that spreads across all device.</p>
